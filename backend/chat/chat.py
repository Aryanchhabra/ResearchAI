...
from research_ai.memory import Memory
from research_ai.config.config import Config
from research_ai.utils.llm import create_chat_completion
from research_ai.utils.tools import create_chat_completion_with_tools, create_search_tool
...
# Note: LLM client is now handled through ResearchAI's unified LLM system
# This supports all configured providers (Ollama, OpenAI, Google Gemini, Anthropic, etc.)
...
class ChatAgentWithMemory:
    ...
    async def chat(self, messages, websocket=None):
        ...
        try:
            ...
            system_prompt = f"""
            You are ResearchAI, an intelligent research assistant powered by advanced AI models.
