...
export default function MobileLayout({
  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-900">
        ...
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center">
            <a href="/" className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-teal-500/20 to-cyan-500/20 border border-teal-500/20 flex items-center justify-center">
                <span className="text-xs font-light text-teal-400">RA</span>
              </div>
      ...
      {/* Footer */}
      <footer className="mt-auto py-4 px-4 text-center border-t border-white/5 bg-black/40 backdrop-blur-xl">
