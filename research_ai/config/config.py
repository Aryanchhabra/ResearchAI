...
class Config:
    ...
    def parse_llm(llm_str: str | None) -> tuple[str | None, str | None]:
        ...
        from research_ai.llm_provider.generic.base import _SUPPORTED_PROVIDERS
    ...
    def parse_embedding(embedding_str: str | None) -> tuple[str | None, str | None]:
        ...
        from research_ai.memory.embeddings import _SUPPORTED_PROVIDERS
